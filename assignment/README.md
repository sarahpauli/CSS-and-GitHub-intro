...
The link pseudo-class selectors (for `a` elements) are covered in chapter 13. They are *demonstrated* in [this video](https://www.youtube.com/watch?v=otVUAinxGKk).
